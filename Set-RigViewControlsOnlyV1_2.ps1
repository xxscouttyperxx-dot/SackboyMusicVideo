...
& $BlenderExe --background ".\blender\sackboy_scene.blend" --python-exit-code 1 --python $ScriptPath -- --mode controls
if($LASTEXITCODE -ne 0){throw "Controls-only rig view failed"}
Write-Host "Controls-only rig view saved."
