...
Write-Host "=== OPTIONAL PUSH CURRENT BASELINE BLEND ONLY ==="
...
git commit -m "Update completed pre-rigging baseline blend"
...
Write-Host "Current baseline blend push succeeded."
