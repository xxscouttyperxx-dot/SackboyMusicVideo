...
Write-Host "=== OPTIONAL PUSH MOTION RETARGET PREP V1.2 BLEND ONLY ==="
...
git commit -m "Prepare Sackboy rig display for motion retargeting"
...
Write-Host "Motion-retarget preparation v1.2 blend push succeeded."
