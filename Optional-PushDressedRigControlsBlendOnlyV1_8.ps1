...
Write-Host "=== OPTIONAL PUSH DRESSED RIG CONTROLS V1.8 BLEND ONLY ==="
...
git commit -m "Add animator controls and switchable IK to Sackboy rig"
...
Write-Host "Dressed-rig control v1.8 blend push succeeded."
