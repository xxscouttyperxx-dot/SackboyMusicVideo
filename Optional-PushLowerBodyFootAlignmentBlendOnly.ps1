...
Write-Host "=== OPTIONAL PUSH LOWER-BODY ALIGNMENT BLEND ONLY ==="
...
git commit -m "Finalize Sackboy lower-body and foot bone alignment"
...
Write-Host "Lower-body alignment blend push succeeded."
