...
Write-Host "=== OPTIONAL PUSH CLEAN BASELINE BLEND ONLY ==="
...
git commit -m "Create clean pre-rigging animation baseline"
...
Write-Host "Clean baseline blend push succeeded."
