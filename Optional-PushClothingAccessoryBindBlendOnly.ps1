...
Write-Host "=== OPTIONAL PUSH CLOTHING / ACCESSORY BIND BLEND ONLY ==="
...
git commit -m "Bind Sackboy clothing eyes and shoes to custom rig"
...
Write-Host "Clothing/accessory binding blend push succeeded."
