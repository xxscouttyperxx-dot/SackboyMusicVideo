...
Write-Host "=== OPTIONAL PUSH F2 BIND / WEIGHTS BLEND ONLY ==="
...
git commit -m "Bind and weight F2 to custom Sackboy armature"
...
Write-Host "F2 binding blend push succeeded."
